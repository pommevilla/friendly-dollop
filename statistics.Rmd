---
title: "A short analysis of impact of treatment on corn and *Miscanthus Gigantus*"
format: 
  html:
...
So we see that we're removing 17 genes. We'll keep it in a long format so we can visualize this:
